...
const examples = [
	{
		...
		src: "app/_examples/client-component/page.tsx",
	},
	{
		type: "Server Components",
		src: "app/_examples/server-component/page.tsx",
	},
			...
			<div className="animate-in flex flex-col gap-14 opacity-0 max-w-4xl px-3 py-16 lg:py-24 text-foreground">
				...
				<div className="flex flex-col gap-8 text-foreground">
					<div className="grid gap-2 justify-center mx-auto text-center">
						...
						<p className="text-sm">
							Look in the <code>_examples</code> folder to see how
							to create a Supabase client in all the different
							contexts.
						</p>
					</div>
